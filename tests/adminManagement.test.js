...
function contentPayload(overrides = {}) {
  return {
    ...
    seoTitle: "[클래식 로테이션 소개팅] 테스트",
    seoDescription: "테스트 검색 설명입니다.\n두 번째 줄입니다.",
    seoImageUrl: "/assets/images/search-preview-classic-rotation.jpg",
    seoImageAlt: "테스트 검색 이미지",
    naverVerification: "test-naver-verification",
